...
import related5 from "../assets/related5.jpg";
...
export const movieDetails = {
    title: "Mickey 17",
    description: "Set in the year 2054, the plot follows a man who joins a space colony as an expendable, a disposable worker who gets cloned every time he dies for research purposes",
    genre: "Action",
    year: "2025",
    duration: "2h 17m",
  ...
  export const relatedMovies = [
    {
      ...
      rating: 4.5,
      year: 2025,
      description: "Two elite snipers receive identical missions: guarding opposite sides of a remote, top-secret gorge for one year without any contact with their counterparts or the outside world. Levi Kane, a former U.S. Marine Scout/Sniper, is recruited by a mysterious woman named Bartholomew to guard the west tower",
      genre: "Action, Romanace",
      duration: "2h 10m",
      starring: "Josh Hutcherson, Anna Kendrick and Aaron Taylor-Johnson",
    ...
    },
    {
      ...
      rating: 4.4,
      year: 2025,
      description: "Set in an alternate technologically ravaged 1990s, it follows a teenage girl and her robot on a journey to the West Coast of the United States in search of her long-lost brother",
      genre: "Action, Adventure, Sci-Fi",
      duration: "2h 10m",
      starring: "Millie Bobby Brown, Chris Pratt and Stanley Tucci",
    ...
    },
    {
      ...
      rating: 4.7,
      year: 2013,
      description: "In the year 2154, the rich live on a luxurious space station called Elysium, while the rest of humanity resides on a ruined Earth. The film follows Max DeCosta, who is tasked with bringing equality to these polarized worlds",
      genre: "Action, Sci-Fi",
      duration: "1h 49m",
    ...
    },
    {
      ...
      duration: "1h 46m",
      starring: "Ryan Reynolds, Walker Scobell and Mark Ruffalo",
      director: "Shawn Levy",
    ...
    },
    {
      ...
      rating: 4.8,
      year: 2019,
      description: "The plot follows Brandon Breyer, a young boy of extraterrestrial origin reared on Earth who discovers he has superpowers, using them with dark intentions",
    ...
    },
    {
      ...
      rating: 4.6,
      year: 2023,
      description: "In the midst of a war between humans and AI, a former soldier is tasked with hunting down the Creator, the elusive architect of advanced AI who has developed a mysterious weapon that has the power to end humanity",
      genre: "Action, Adventure, Sci-Fi",
      duration: "2h 13m",
      starring: "John David Washington, Gemma Chan and Ken Watanabe",
      director: "Gareth Edwards",
      backgroundImage: cover6,
      thumbnail: related6
    },
    {
      id: 7,
      ...
      rating: 4.7,
      year: 2014,
      description: "A science fiction action film where a public relations officer, Major William Cage, gets thrust into a brutal war against an alien race",
      genre: "Action, Sci-Fi",
      duration: "1h 53m",
      starring: "Tom Cruise, Emily Blunt and Bill Paxton",
      director: "Doug Liman",
      backgroundImage: cover7,
      thumbnail: related7
    },
    {
      id: 8,
      ...
      rating: 4.5,
      year: 2015,
      description: "Chappie is a science fiction film about a police droid who is given new programming and becomes the first robot with the ability to think and feel for himself",
      genre: "Action, Crime, Drama",
      duration: "2h 0m",
      starring: "Sharlto Copley, Dev Patel and Hugh Jackman",
      director: "Neill Blomkamp",
      backgroundImage: cover8,
      thumbnail: related8
    }
  ];
  export const actionMovies = [
        {
            id: 'action-1',
            title: "The Guardian",
            description: "An elite guardian faces his toughest mission yet protecting a high-profile target in this action-packed thriller.",
            genre: "Action, Thriller",
            year: 2025,
            duration: "2h 15m",
            starring: "Chris Evans, Emily Blunt",
            director: "Antoine Fuqua",
            rating: 7.1,
            backgroundImage: guadian,
            thumbnail: guadian,
            image: guadian
        },
        {
            id: 'action-2',
            title: "Deadpool",
            description: "A wisecracking mercenary with accelerated healing powers goes on a violent quest for revenge.",
            genre: "Action, Comedy",
            year: 2024,
            duration: "1h 58m",
        ...
        },
        {
            id: 'action-3',
            title: "I am Legend",
            description: "A scientist is the last human survivor in New York City, fighting against mutants in a post-apocalyptic world.",
            genre: "Action, Sci-Fi",
            year: 2024,
            duration: "2h 5m",
        ...
        },
        {
            ...
            description: "An intense action thriller set in the heart of Paris, following an elite operative's mission to prevent a terrorist attack.",
            genre: "Action, Thriller",
            year: 2014,
            duration: "2h 10m",
            starring: "Jean Reno, Sophie Marceau",
            director: "Luc Besson",
            rating: 7.3,
            backgroundImage: judgement_of_paris,
            thumbnail: judgement_of_paris,
            image: judgement_of_paris
        },
        {
            id: 'action-5',
            title: "Lethal Weapon",
            description: "Two mismatched cops form an unlikely partnership as they investigate a series of mysterious crimes.",
            genre: "Action, Crime",
            year: 2021,
            duration: "2h 8m",
            ...
            rating: 9.0,
            backgroundImage: lethal_weapon,
            thumbnail: lethal_weapon,
            image: lethal_weapon
        },
        {
            id: 'action-6',
            title: "The Avenger",
            description: "A lone warrior seeks revenge against a powerful criminal organization that destroyed everything he held dear.",
            genre: "Action, Drama",
            year: 2015,
            duration: "2h 20m",
            ...
            rating: 10.0,
            backgroundImage: theAvenger,
            thumbnail: theAvenger,
            image: theAvenger
        },
        {
            id: 'action-7',
            title: "The Last Soldier",
            description: "In a war-torn future, the last remaining super-soldier must complete a mission that could save humanity.",
            genre: "Action, Sci-Fi",
            year: 2014,
            duration: "2h 12m",
            ...
            rating: 7.3,
            backgroundImage: the_last_soldier,
            thumbnail: the_last_soldier,
            image: the_last_soldier
        }
  ];
